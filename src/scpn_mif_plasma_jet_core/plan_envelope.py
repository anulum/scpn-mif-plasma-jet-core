...
# SCPN MIF Plasma Jet Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-MIF-PLASMA-JET-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_mif_plasma_jet_core.observability.CATALOGUE_BINDING`.
    plan_identifier
