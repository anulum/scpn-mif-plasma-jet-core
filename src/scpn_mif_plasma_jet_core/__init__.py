...
# SCPN MIF Plasma Jet Core — device capability package

"""Device capability models of the SCPN plasma-jet-MIF device family.
...
from scpn_mif_plasma_jet_core.errors import (
...
from scpn_mif_plasma_jet_core.physics import (
    LEVEL0_NON_CLAIMS,
    LEVEL0_SCHEMA,
