...
SCPN MIF Plasma Jet Core — ROADMAP
-->
...
- **Diagnostic and clock semantics** (landed 2026-08-31) — synthetic
  ...
  (jet-arrival train, convergence trajectory, merge-asymmetry set, synthetic oscillator); `computational_prototype` (ADR 0003,
...
MagLIF solid-liner implosion, mechanical/liquid liners, FRC physics, the
