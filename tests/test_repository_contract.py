...
# SCPN MIF Plasma Jet Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_mif_plasma_jet_core/configuration.py",
    "src/scpn_mif_plasma_jet_core/errors.py",
    "src/scpn_mif_plasma_jet_core/observability.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-MIF-PLASMA-JET-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_mif_plasma_jet_core import OWNED_CONFIGURATIONS, RegistryBinding
