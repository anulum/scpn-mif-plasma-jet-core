...
# SCPN MIF Plasma Jet Core — portable diagnostic-plan envelope tests
...
FIXTURE_SHA256 = "7be8b628ab349db920cccbbe2a405ebedbcdc70839c6d0b0f8d8bc84386717f8"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-MIF-PLASMA-JET-CORE"
    assert NON_CLAIMS == (
